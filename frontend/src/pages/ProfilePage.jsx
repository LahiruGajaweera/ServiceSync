...
export default function ProfilePage() {
  ...
  const handleRequestOtp = async (e) => {
    ...
    setStatus(null);
    try {
      const res = await api.post('/auth/update-password/request-otp');
  ...
  const handleVerifyOtp = async (e) => {
    e.preventDefault();
    if (otpCode.length !== 6) {
      setStatus({ type: 'error', message: 'Enter a 6-digit verification code.' });
      return;
    }
  ...
  return (
    <div className="min-h-full bg-white dark:bg-gray-800 dark:bg-gray-900 p-8 flex flex-col">
      <div className="max-w-6xl mx-auto w-full flex-1 flex flex-col">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Manage your account details and security settings.</p>
          </div>
          ...
          {user?.role === 'technician' && performance && (
            <div className="relative group overflow-hidden flex items-center gap-5 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/80 p-3 pr-6 rounded-2xl border border-gray-200/60 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5">
              ...
              <div className="relative flex items-center justify-center w-14 h-14 bg-white dark:bg-gray-800 dark:bg-gray-900 rounded-full shadow-inner p-1">
                <svg className="w-full h-full transform -rotate-90 drop-shadow-sm" viewBox="0 0 36 36">
                  <path className="text-gray-100 dark:text-gray-800 dark:text-gray-100" strokeWidth="2.5" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 h-full">
            ...
            {/* Avatar & Name */}
            <div className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-800/50 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center text-center flex-1">
              <div 
              ...
              >
                ...
                <div className="w-24 h-24 rounded-full overflow-hidden bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center text-4xl font-bold border-4 border-white dark:border-gray-800 transition-colors group-hover:bg-blue-200 dark:group-hover:bg-blue-900/50 shadow-md">
                  {user?.avatar_url ? (
                    <img 
              ...
              <div className="w-full">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 truncate flex items-center justify-center gap-2 mt-1">
            ...
            {/* Contact Details */}
            <div className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-800/50 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 flex-1 flex flex-col justify-center">
              <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2 uppercase tracking-widest">
              ...
              <div className="space-y-4">
                {user?.phone_number ? (
                  <div>
                    ...
                    <div className="text-gray-900 dark:text-white dark:text-gray-200 text-base font-medium">{user.phone_number}</div>
                  </div>
                ) : (
          ...
          <div className="lg:col-span-7 h-full">
            <div className="bg-white dark:bg-gray-800/30 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-700 h-full flex flex-col justify-center shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                <div className="p-2.5 bg-gray-50 dark:bg-gray-900 dark:bg-gray-800 rounded-lg text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700">
              ...
              <form onSubmit={step === 1 ? handleRequestOtp : handleVerifyOtp} className="space-y-8 max-w-lg">
                {status && (
                ...
                {step === 1 ? (
                  <>
                    <div className="space-y-6">
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200 dark:text-gray-300 mb-2">New Password</label>
                        <input
                          type="password"
                          required
                          value={newPassword}
                          onChange={(e) => setNewPassword(e.target.value)}
                          className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white transition-all shadow-sm"
                          placeholder="Minimum 8 characters"
                        />
                      </div>
                      
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200 dark:text-gray-300 mb-2">Confirm Password</label>
                        <input
                          type="password"
                          required
                    ...
                    <div className="pt-4">
                      <button
                        type="submit"
                        disabled={saving}
                        className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-6 py-2.5 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-3 shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 hover:-translate-y-0.5"
                      >
                        {saving && (
                  ...
                  <>
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800/50 mb-6">
                      <p className="text-sm text-blue-800 dark:text-blue-300">
                        We've sent a 6-digit verification code to <strong>{maskedDest}</strong>.
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white transition-all shadow-sm tracking-widest text-lg font-mono text-center"
                        placeholder="• • • • • •"
                      />
                    </div>
                    ...
                    <div className="pt-4 flex items-center gap-3">
                      <button
                        ...
                        className="px-6 py-2.5 rounded-lg text-sm font-bold border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                      >
                        Cancel
                      </button>
                      <button
