            ...
            <div>
              ...
              <div className="space-y-1.5">
                {parts.inventory_parts.map((p) => (
                  <div key={p.id} className="flex items-center justify-between bg-white dark:bg-gray-800 rounded-lg px-3 py-2 text-xs shadow-sm">
                    <span className="font-medium text-gray-800 dark:text-gray-100">{p.name}</span>
                    <div className="flex items-center gap-3 text-gray-500 dark:text-gray-400">
                      <span>Qty: <strong className="text-gray-700 dark:text-gray-200">{p.quantity}</strong></span>
