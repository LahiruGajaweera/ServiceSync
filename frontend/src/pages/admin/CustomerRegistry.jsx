  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Customer Registry</h2>
      ...
      <form onSubmit={handleSearch} className="mb-5 flex gap-2">
        ...
        {search && (
          <button
            ...
            className="text-gray-500 hover:text-gray-700 px-3 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50"
          >
            Clear
          </button>
        )}
